  ...
  if (!online) {
    return (
      <LiveRegion politeness="assertive">
        <div
          role="alert"
          className="t-body mb-3 flex items-center gap-2 rounded-[var(--radius-md)] border border-[var(--signal-warning-line)] bg-[var(--signal-warning-soft)] px-3 py-2 text-[var(--signal-warning)]"
        >
          <span
            aria-hidden
