...
const buttonVariants = cva(
  't-control inline-flex select-none items-center justify-center gap-1.5 whitespace-nowrap rounded-[var(--radius-md)] transition-all duration-[var(--dur-1)] ease-[var(--ease)] active:scale-[0.96] disabled:pointer-events-none disabled:opacity-40 disabled:active:scale-100',
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          'border border-border bg-surface text-ink shadow-[var(--shadow-1)] hover:border-border-strong hover:bg-[var(--surface-sunken)]/50',
        ghost:
          'text-ink-2 hover:bg-[var(--surface-sunken)] hover:text-ink',
        critical:
